...
export const metadata = pageMetadata("/news/copyright-and-emerging-issues-due-to-artificial-intelligence");

export default function CopyrightAILecturePage() {
  return (
    <main className="min-h-screen bg-white overflow-hidden">
      <PageSchema path="/news/copyright-and-emerging-issues-due-to-artificial-intelligence" />
      {/* Breadcrumbs */}
      ...
      <section className="relative w-full bg-white border-b border-gray-100">
        <div className="flex flex-col lg:flex-row min-h-0 lg:min-h-[450px]">
          ...
          <div className="lg:w-[55%] relative min-h-[200px] sm:min-h-[240px] lg:min-h-[450px]">
            <Image
