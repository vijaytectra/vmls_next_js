...
export const metadata = pageMetadata("/news/ai-for-justice-vmls-setu-law-workshop");

export default function AIForJusticePage() {
  return (
    <main className="min-h-screen bg-[#f5f3ef] overflow-hidden">
      <PageSchema path="/news/ai-for-justice-vmls-setu-law-workshop" />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-6 text-white/80 py-4 border-y border-white/10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium uppercase tracking-widest">January 15, 2025</span>
            </div>
          </div>
        </div>
      </section>
