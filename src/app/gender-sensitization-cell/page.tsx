...
export const metadata = pageMetadata("/gender-sensitization-cell");
...
export default function GenderSensitizationCellPage() {
  return (
    <main className="min-h-screen bg-white">
      <PageSchema path="/gender-sensitization-cell" />
      {/* Breadcrumb */}
      <nav className="px-[5%] py-4 sm:py-6 bg-gray-50 border-b border-gray-100 overflow-x-auto no-scrollbar">
        <div className="max-w-7xl mx-auto flex items-center gap-2 sm:gap-3 text-xs min-[380px]:text-sm sm:text-base md:text-lg font-medium whitespace-nowrap">
          ...
          <span className="text-[#a31f34] font-semibold shrink-0">Gender Sensitization Cell</span>
        </div>
      </nav>
