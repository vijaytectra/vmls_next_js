      ...
      <section className="py-12 px-[5%]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="font-playfair text-3xl font-bold text-[#800000] mb-6 flex items-center gap-4 text-left">
            ...
            {/* 2. Use of Cookies */}
            <section>
              <h2 className="font-playfair text-3xl font-bold text-[#800000] mb-8 flex items-center gap-4 text-left">
              ...
              <div className="space-y-4 pl-4 border-l-2 border-gray-100 text-gray-700 leading-relaxed">
                <p className="text-left">Cookies are small files stored on your device (if you allow) that enable websites to recognize your browser and remember certain information. We use cookies to:</p>
                ...
                <p className="text-left">A cookie cannot read any data off your hard drive or access personal information beyond what you voluntarily provide. Our advertisers or third-party service providers may place their own cookies if you click on their ads or links—this process is outside our control.</p>
                <p className="text-left">If you prefer not to receive cookies, you can adjust your browser settings to delete or block them. Refer to your web browser&apos;s &quot;Help&quot; documentation for more details.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-100 text-gray-700 leading-relaxed space-y-4">
                <p className="text-left">We implement security measures to maintain the safety of personal information you submit. All information gathered on the Vinayaka Mission&apos;s Law School website is stored in a secure database on servers protected by firewalls and password-restricted access.</p>
                <p className="text-left">Despite these measures, no security system is impenetrable. We cannot guarantee the security of our database nor that information you transmit over the Internet will not be intercepted. Additionally, any information you post in public areas of our website (such as discussion forums) can be accessed by anyone online.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-100 text-gray-700 leading-relaxed space-y-4">
                <p className="text-left">Occasionally, we may include or offer third-party products or services on our website. These third-party sites are governed by their own privacy policies, and we bear no responsibility or liability for their content or activities. We welcome feedback about these sites to help maintain the integrity of our platform.</p>
                <p className="text-left">We do not share your personally identifiable information with these third parties without your explicit consent. However, we may share aggregated statistics on site traffic to help advertisers or partners understand our audience—this data does not include personal identifiers.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-100 text-gray-700 leading-relaxed space-y-4">
                <p className="text-left">We do not sell, trade, or otherwise transfer your personally identifiable information to external parties, except:</p>
                <ul className="list-disc pl-6 space-y-3">
                ...
                <p className="text-left">We may provide non-personally identifiable, aggregated visitor information to third parties for marketing, advertising, or other uses.</p>
              </div>
            </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 pt-8">
              <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                <h3 className="font-playfair text-xl font-bold text-[#800000] mb-4 text-left">7. Online Privacy Policy Only</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-left">This Privacy Policy applies only to information collected through our website and not to any data collected offline.</p>
              </div>
              <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                <h3 className="font-playfair text-xl font-bold text-[#800000] mb-4 text-left">8. Your Consent</h3>
                <p className="text-gray-600 text-sm leading-relaxed text-left">By using our site, you consent to this Privacy Policy in its entirety. This includes consenting to our right to contact you by phone, SMS, email, or WhatsApp regarding our offerings, even if your number is on a DND list, when you have voluntarily provided your contact details.</p>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              ...
              <div className="space-y-4 text-lg text-gray-700 leading-relaxed font-inter">
                <p className="text-left">If you have questions regarding this Privacy Policy or wish to update personal information you have shared, please contact us at:</p>
                <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
