          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-yellow-200">
              <div className="flex items-center gap-2">
                ...
                <p className="font-inter text-sm"><span className="font-bold text-[#1a1a1a]">Duration:</span> 60 minutes.</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-[#a31f34] rounded-full"></span>
                <p className="font-inter text-sm"><span className="font-bold text-[#1a1a1a]">Mode:</span> Online AI Proctored.</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-[#a31f34] rounded-full"></span>
                <p className="font-inter text-sm"><span className="font-bold text-[#1a1a1a]">Bilingual:</span> English & Tamil.</p>
              </div>
            </div>
          </div>
        </div>
