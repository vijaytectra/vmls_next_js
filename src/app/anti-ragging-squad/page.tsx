...
export const metadata = {
  ...
  description: "Members and contact details of the Anti Ragging Squad at Vinayaka Mission's Law School.",
};
      ...
      <section className="bg-[#800000] text-white py-16 px-[5%]">
        <div className="max-w-7xl mx-auto text-center lg:text-left">
          <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Anti Ragging <span className="text-[#fbb03b]">Squad</span>
          </h1>
          ...
          <p className="font-inter text-xl opacity-90 max-w-3xl leading-relaxed mx-auto lg:ml-0">
            The Anti Ragging Squad at VMLS is responsible for maintaining constant vigil and preventing any incidents of ragging on campus.
          </p>
        </div>
      </section>
