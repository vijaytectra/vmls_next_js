// Hand-maintained redirects. Add new one-off rules HERE, not in
// src/data/redirects.ts, which is generated and overwritten.
// The generator merges these first and they win on any source collision.
