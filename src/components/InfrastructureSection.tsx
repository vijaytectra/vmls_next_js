...
export default function InfrastructureSection() {
  ...
  return (
    <section className="pt-2 pb-8 md:pt-4 md:pb-6 bg-white overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-[5%]">
        <h2 className="font-playfair text-4xl md:text-6xl text-[#1a1a1a] mb-2 md:mb-16 text-center">
          Our Infrastructure
        </h2>
          ...
          {infraItems.map((item, index) => {
            ...
            return (
              <div 
                ...
                className={`relative transition-all duration-700 ease-in-out cursor-pointer overflow-hidden bg-[#5a5a5a] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)] p-2 lg:p-3
              ...
              >
                ...
                <div className="absolute inset-0 p-8 lg:p-12 flex flex-col justify-end">
                  <div className={`transition-all duration-500 transform ${isHovered ? "translate-y-0" : "translate-y-4"}`}>
                    ...
                    <div className="flex items-center gap-3 text-white font-inter text-xs font-bold uppercase tracking-widest group/btn">
                      <span>Read More</span>
